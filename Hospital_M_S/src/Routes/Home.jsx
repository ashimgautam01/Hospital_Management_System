...
const Home = ({ isStaff }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      {/* Loading Screen */}
      {!videoLoaded && (
        <div className="fixed inset-0 bg-gradient-to-br from-teal-600 to-blue-700 flex items-center justify-center z-50">
          <div className="text-center text-white">
            ...
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="text-xl font-semibold">Loading Healthcare Experience...</span>
            </div>
